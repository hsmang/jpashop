...
public class OrderQueryRepository {
    ...
    public List<OrderItemQueryDto> findOrderItems(Long orderId){
        return em.createQuery(
                "select new com.study.study_jpa.repository.order.query.OrderItemQueryDto(oi.order.id, i.name, oi.orderPrice, oi.count)" +
                        " from OrderItem oi" +
                        " join oi.item i" +
    ...
    public List<OrderQueryDto> findOrders(){
        return em.createQuery(
                "select new com.study.study_jpa.repository.order.query.OrderQueryDto(o.id, m.name, o.orderDate, o.status, d.address) from Order o " +
                        " join o.member m" +
    ...
    public List<OrderFlatDto> findallByDto_flat() {
        return em.createQuery(
                "select new com.study.study_jpa.repository.order.query.OrderFlatDto(o.id, m.name, o.orderDate, o.status, d.address, i.name, oi.orderPrice, oi.count)" +
                        " from Order o " +
                        " join o.member m" +
                        " join o.delivery d" +
